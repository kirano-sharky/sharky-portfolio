...
const Blog = () => {
  return (
    <div className='items-center bg-white dark:bg-gray-700 h-screen py-6 relative sm:px-16 px-12 text-white overflow-hidden flex flex-col justify-center align-middle overflow-y-auto '>
      ...
      <div className='container mx-auto z-10 relative lg:top-10 top-[200px]'>
        <div className='lg:flex-row flex-col column gap-[30px] justify-center grid grid-cols-2 '>
          <div className='border-gray-700 dark:border-gray-500 border-2 w-[380px] lg:h-[480px] lg:w-[580px] rounded-lg column justify-center space-y-3 shadow-lg dark:shadow-lg dark:shadow-gray-600'>
            ...
            <div className='flex justify-center'>
              <button className='border-2 border-gray-400 opacity-50 hover:opacity-100 w-[450px] rounded-lg h-[50px]'>Read me more!</button>
            </div>
          </div>
          {/** */}
          <div className='border-gray-700 dark:border-gray-500 border-2 w-[380px] lg:h-[480px] lg:w-[580px] rounded-lg column justify-center space-y-3 shadow-md dark:shadow-lg dark:shadow-gray-600 '>
            <div className='flex justify-start relative top-12 left-7'>
              <span className='dark:text-white text-black font-bold text-[25px]'>Stay in the zoo...</span>
            </div>
            <div className='flex justify-end'>
